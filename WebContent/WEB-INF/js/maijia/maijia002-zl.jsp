...
<body onload="MM_preloadImages('ima/shaodaiyuan/an003.png')">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td height="700" valign="top" background="../xueshengshaodai/ima/捎带员"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td><span class="a004">完善和修改资料：</span></td>
                  </tr>
                </table>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" background="../xueshengshaodai/ima/shaodaiyuan/ziliaobaise006.png">
                  <tr>
                    <td height="175" align="center" valign="middle"><form id="form1" name="form1" method="post" action="">
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                        ...
                        <tr>
                          ...
                          <td>&nbsp;</td>
                          <td height="30"><input name="textfield8" type="password" id="textfield8" /></td>
                        </tr>
                        <tr>
                          <td align="right" valign="middle"><span class="a005">密&nbsp;&nbsp;&nbsp;码</span></td>
                          <td>&nbsp;</td>
                          <td height="30"><input name="textfield6" type="password" id="textfield6" />
                            &nbsp;<span class="juli">6-20位大小写字母、数字、特殊符号等。</span></td>
                        </tr>
                        <tr>
                          <td align="right" valign="middle"><span class="a005">确认密码</span></td>
                          <td>&nbsp;</td>
                          <td height="30"><input name="textfield7" type="password" id="textfield7" />
                            &nbsp;<span class="juli">再次输入一次密码。</span></td>
                        </tr>
                        <tr>
                          <td align="right" valign="middle"><span class="a005">店 &nbsp;&nbsp;名</span></td>
                          <td>&nbsp;</td>
                          <td height="30"><input name="textfield5" type="text" id="textfield5" value="三餐2号窗口小土豆炖菜馆" />
                        ...
                        <tr>
                          ...
                          <td height="30"><label for="textfield3"></label>
                            <input name="textfield3" type="text" id="textfield3" value="三餐二楼2号窗口" />
                            <span class="hongse">*</span></td>
                        </tr>
                        <tr>
                          ...
                          <td height="30"><label for="textfield2"></label>
                            ...
                            <span class="hongse">*<a href="#" class="dizhi">修改手机号</a></span></td>
                        </tr>
                        <tr>
                          <td align="right" valign="middle">保险金额</td>
                          <td>&nbsp;</td>
                          <td height="30"><label for="textfield2">&nbsp;&nbsp; 200元
                            <input type="submit" name="indext" id="indext" value="提交金额" />
                          </label></td>
                        </tr>
                        <tr>
                          <td align="right" valign="middle">&nbsp;</td>
                          <td>&nbsp;</td>
                          <td height="30">&nbsp;<span class="hongse">*注： 开店必须缴纳保证金200元人民币，可随时退款，详情查看《保险规则》。</span></td>
                        </tr>
                        <tr>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td><span class="a004">身份认证：</span></td>
                  </tr>
                </table>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td height="42" align="center" valign="middle"><img src="../xueshengshaodai/ima/shaodaiyuan/sfz001.png" width="42" height="42" /></td>
                        <td>身份证：</td>
                        <td height="42">37142*************4236</td>
                        <td>已绑定 &gt;</td>
                      </tr>
                      <tr>
                        <td height="42" align="center" valign="middle"><img src="ima/spxkz001.png" width="42" height="42" /></td>
                        <td align="left" valign="middle"><span class="a005">食品流通许可证：</span></td>
                        <td height="42">5657*****************6778</td>
                        <td>已绑定 &gt;</td>
                      </tr>
                      <tr>
                        <td width="6%" align="center" valign="middle"><img src="../xueshengshaodai/ima/weixin.png" width="42" height="42" /></td>
                        <td width="15%">微信：</td>
                        <td width="64%" height="42">lisi****98</td>
                        <td width="15%">已绑定 &gt;</td>
                      </tr>
                      <tr>
                        <td align="center" valign="middle"><img src="../xueshengshaodai/ima/tengxun.png" width="42" height="42" /></td>
                        <td>QQ：</td>
                        <td height="42">865****143</td>
                        <td>已绑定 &gt;</td>
                      </tr>
                      <tr>
                        <td align="center" valign="middle"><img src="../xueshengshaodai/ima/weibo.png" width="42" height="42" /></td>
                        <td>微博：</td>
