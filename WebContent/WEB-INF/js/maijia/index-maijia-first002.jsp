...
.wanshan {
	background-image: url(ima/wanshan001.png);
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td height="700" valign="top" background="../xueshengshaodai/ima/捎带员"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td><span class="a004">完善资料：</span></td>
                </tr>
              </table>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                  ...
                  <tr>
                    ...
                    <form id="form1" name="form1" method="post" action="/caseShoppingBook/userServlet?method=sellerInfoOnePage" enctype="multipart/form-data">
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                          <td align="right" valign="middle" class="a005">&nbsp;</td>
                          <td>&nbsp;</td>
                          <td height="30"><label for="textfield2">&nbsp;&nbsp;<span class="hongse">*注： 开店必须缴纳保证金200元人民币，可随时退款，详情查看《保险规则》。</span></label></td>
                        </tr>
                        <tr>
